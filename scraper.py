...
for role in roles:
    ...
    with open(os.path.join(r'C:\Users\matth\Desktop\PL\GeoJSON', filename), 'w+') as f:
        f.write("[\n")
        browser.get(
            "https://hsreplay.net/cards/#rankRange=LEGEND&playerClass=" + role + "&timeRange=CURRENT_EXPANSION&gameType=RANKED_CLASSIC")
